...
if rank == 0:
    ...
    # Save the results
    df_errors.to_csv("bootstrap_errors_normal_xthreat_max_error_full.csv", index=False)
    print(f"Calculated the error of {df_errors.shape[0]} models.")
    print("Final results saved as 'bootstrap_errors_normal_xthreat_max_error_full.csv'")
